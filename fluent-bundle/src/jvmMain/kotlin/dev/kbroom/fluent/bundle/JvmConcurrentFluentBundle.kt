 ...
 */
class JvmConcurrentFluentBundle(
    ...
    fun formatPattern(pattern: Pattern, args: FluentArgs? = null, errors: MutableList<FluentError> = mutableListOf()): String {
        lock.readLock().lock()
        try {
    ...
    companion object {
        @JvmStatic
        fun new(locales: List<LanguageIdentifier>): JvmConcurrentFluentBundle {
            return JvmConcurrentFluentBundle(locales)
        }
    }
}
